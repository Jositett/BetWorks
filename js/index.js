...
//     // Draw a bar chart
//     var chartCanvas = details.querySelector('#chart');
//     var data = {
//         labels: ['Home Rating', 'Away Rating'],
//         datasets: [{
//             label: 'Ratings',
//             data: [rowData['Home Rating'], rowData['Away Rating']],
...
//     // Create table rows for each field in the rowData
